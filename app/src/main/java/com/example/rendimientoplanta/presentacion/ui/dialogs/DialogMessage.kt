...
class DialogMessage(
    ...
    interface FinalizoDialog {
         ...
         * @param dialog
         */
        fun resultadoYesDialog(dialog: Dialog?)
        fun resultadoNoDialog(dialog: Dialog?)
    }
    ...
    init {
        ...
        dialog.setContentView(R.layout.dialog_message) //añado el dialogo que voy a mostrar

        dialog.labelSuccess.text = label
        dialog.btnCancelar.setOnClickListener {finalizoDialog.resultadoNoDialog(dialog)}
        dialog.btnGuardar.setOnClickListener {finalizoDialog.resultadoYesDialog(dialog)}
